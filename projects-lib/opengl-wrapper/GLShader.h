...
namespace openglWrapper {
    ...
    protected:
        ...
        void setUniform(int location, const aRibeiro::vec2 &v);///< Setup an uniform from vec2 value
        void setUniform(int location, const aRibeiro::vec3 &v);///< Setup an uniform from vec3 value
        void setUniform(int location, const aRibeiro::vec4 &v);///< Setup an uniform from vec4 value
        void setUniform(int location, const aRibeiro::mat4 &v);///< Setup an uniform from mat4 value
        ...
        aRibeiro::vec2 getUniformVec2(int location);///< Query an uniform from vec2 value
        aRibeiro::vec3 getUniformVec3(int location);///< Query an uniform from vec3 value
        aRibeiro::vec4 getUniformVec4(int location);///< Query an uniform from vec4 value
        aRibeiro::mat4 getUniformMat4(int location);///< Query an uniform from mat4 value
