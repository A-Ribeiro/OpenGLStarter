...
namespace openglWrapper {
    ...
    void PlatformGL::checkShaderStatus(int shader, const char* file, unsigned int line, const char* aux_string) {
        GLint success;
        #ifdef ARIBEIRO_RPI
    ...
    void PlatformGL::checkProgramStatus(int program, const char* file, unsigned int line, const char* aux_string) {
        GLint success;
        #ifdef ARIBEIRO_RPI
