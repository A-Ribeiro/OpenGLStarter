...
{
    return (f_minus_n * n) / (f_plus_n - z * f_minus_n) + n;"
}
```
...
void main() {
  ...
  float cameraDistance_01 = (particle_depth - uCameraNearFar.x) - 1.0;
...
You can see the current implementation on this [link](https://github.com/A-Ribeiro/OpenGLStarter/tree/master/projects/tech-demo-particle).
