...
namespace AppKit
{
    namespace GLEngine
    {
        ...
        namespace Components
        {
            ...
            void ComponentCameraLookToNode::Deserialize(rapidjson::Value &_value, std::unordered_map<intptr_t, std::shared_ptr<Transform>> &transform_map, std::unordered_map<intptr_t, std::shared_ptr<Component>> &component_map){
