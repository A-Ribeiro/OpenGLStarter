...
namespace AppKit
{
    namespace GLEngine
    {
        ...
        namespace Components
        {
            ...
            void ComponentCameraMove::Deserialize(rapidjson::Value &_value, std::unordered_map<intptr_t, std::shared_ptr<Transform>> &transform_map, std::unordered_map<intptr_t, std::shared_ptr<Component>> &component_map){
