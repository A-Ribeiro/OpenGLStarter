    ...
    namespace GLEngine
    {
        ...
        namespace Components
        {
            ...
            */
            ...
            void ComponentCameraOrthographic::Deserialize(rapidjson::Value &_value, std::unordered_map<uint64_t, std::shared_ptr<Transform>> &transform_map, std::unordered_map<uint64_t, std::shared_ptr<Component>> &component_map){
