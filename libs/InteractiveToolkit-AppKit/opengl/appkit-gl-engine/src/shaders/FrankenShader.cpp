                        ...
                        if (frankenFormat & (ShaderAlgorithms_ShadowSunLight0 << k))
                        {
                            ...
                            findAndReplaceAll(&vertexShader,
                                              ...
                                              findAndReplaceAllExt(
                                                  ...
                                                  "  vShadowLight_proj_projected_ID = (abs(vShadowLight_proj_ID.w) < 1e-8) ? vec3(0.0) : vShadowLight_proj_ID.xyz / vShadowLight_proj_ID.w;\n"
            ...
            */
            ...
            if (frankenFormat & ShaderAlgorithms_AmbientLightSpheremap)
            {
                ...
                if (frankenFormat & ShaderAlgorithms_sRGB)
                {
                    findAndReplaceAll(&fragmentShader,
                                      "SHADER_CODE",
                                      "  vec3 texelEnvironment = gammaToLinear(sampleEnvironmentSpheremap(uTextureSphereAmbient,N));\n"
                ...
                else
                {
                    findAndReplaceAll(&fragmentShader,
                                      "SHADER_CODE",
                                      "  vec3 texelEnvironment = sampleEnvironmentSpheremap(uTextureSphereAmbient,N);\n"
                                      "  texel.rgb += albedo * texelEnvironment;\n"
                                      "SHADER_CODE");
                }
            }
            else if (frankenFormat & ShaderAlgorithms_AmbientLightSkybox)
            {
                ...
                if (frankenFormat & ShaderAlgorithms_sRGB)
                {
                    findAndReplaceAll(&fragmentShader,
                                      "SHADER_CODE",
                                      "  vec3 texelEnvironment = gammaToLinear(sampleEnvironmentCubeBaryLerp(uTextureCubeAmbient,N));\n"
                                      "  texel.rgb += albedo * texelEnvironment;\n"
                                      "SHADER_CODE");
                }
                else
                {
                    findAndReplaceAll(&fragmentShader,
                                      "SHADER_CODE",
                                      "  vec3 texelEnvironment = sampleEnvironmentCubeBaryLerp(uTextureCubeAmbient,N);\n"
                                      "  texel.rgb += albedo * texelEnvironment;\n"
                                      "SHADER_CODE");
                }
            }
            ...
            if (has_shadow)
            {
                    ...
                    shaderShadowAlgorithm == ShaderShadowAlgorithm_PCSS_DST_CENTER)
                {
                    ...
                    findAndReplaceAll(&fragmentShader,
                                      ...
                                      "bool is_shadow_pos_inside_clip_space(vec4 pos_homogeneous) {\n"
                    ...
                    if (shaderShadowAlgorithm == ShaderShadowAlgorithm_Basic || shaderShadowAlgorithm == ShaderShadowAlgorithm_2x2PCF)
                    {
                        ...
                        findAndReplaceAll(&fragmentShader,
                                          ...
                                          findAndReplaceAllExt(
                                              ...
                                              "  if (is_shadow_pos_inside_clip_space(vShadowLight_proj_ID))\n"
