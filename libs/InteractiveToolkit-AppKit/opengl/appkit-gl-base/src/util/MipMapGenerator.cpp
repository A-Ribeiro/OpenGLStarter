...
namespace AppKit
{
    ...
    namespace OpenGL
    {
        ...
        {
            ITK_ABORT((width > 1 && (width != (src.width >> 1))) ||
                          (height > 1 && (height != (src.height >> 1))),
                      "Mip Map Processing error...\n");
                                         ...
                                         int channels)
        {
            ...
            ITK_ABORT((!power_of_two_w || !power_of_two_h), "MipMap Generator need texture to be power of two.\n");
