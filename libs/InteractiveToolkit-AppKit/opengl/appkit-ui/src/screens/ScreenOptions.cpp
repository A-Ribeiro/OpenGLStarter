#include <appkit-ui/screens/ScreenOptions.h>
#include <appkit-ui/ScreenManager.h>
#include <appkit-ui/screens/Options/TopBar.h>
#include <appkit-ui/screens/Options/OptionSet.h>
#include <appkit-ui/screens/ScreenMessageBox.h>
...
namespace AppKit
{
    namespace ui
    {
        ...
        {
            localContext = STL_Tools::make_unique<OptionsManager>();
            *localContext = *OptionsManager::Instance();
                ...
                for (auto group_key : localContext->getGroupKeys(group))
                {
                    ...
                    optionItem.onChange = [this, group, group_key](const std::string &selected)
                    {
                        ...
                        if (updated && group == "Video" && group_key == "WindowMode")
                        {
                            ...
                            std::string new_key_selected_entry = OptionsManager::Instance()->getGroupValueSelectedForKey("Video", "Resolution");
