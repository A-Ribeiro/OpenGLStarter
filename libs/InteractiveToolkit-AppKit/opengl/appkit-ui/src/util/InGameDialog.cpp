#include <appkit-ui/util/InGameDialog.h>
...
namespace AppKit
{
    namespace ui
    {
            ...
            EventCore::Callback<void()> onContinuePressed)
        {
            ...
            int line_count = 1;
            rich_message_source = "";
            AppKit::ui::RichMessageTokenizer line_tokenizer(rich_message);
            ...
            {
                this->rich_message = "";
                this->text_tokenizer = AppKit::ui::RichMessageTokenizer(rich_message_source);
