...
void OnWindowEvent(const WindowEvent &event)
{
    ...
    case WindowEventType::GainedFocus:
        io.AddFocusEvent(true);
        {
            ...
            io.AddMousePosEvent((float)mouse.x / io.DisplayFramebufferScale.x, (float)mouse.y / io.DisplayFramebufferScale.y);
        }
        break;
...
void OnMouseEvent(const MouseEvent &event)
{
    ...
    case MouseEventType::Moved:
    {
        ...
        io.AddMousePosEvent((float)pos.x / io.DisplayFramebufferScale.x, (float)pos.y / io.DisplayFramebufferScale.y);
    }
    break;
    }
}
