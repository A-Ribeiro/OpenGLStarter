...
bool    ImGui_ImplOpenGL3_Init(const char* glsl_version)
{
    ...
    OPENGL_CMD(glGetIntegerv(GL_TEXTURE_BINDING_2D, &current_texture));
    ...
    if (num_extensions == 0){
        //2.1 case
        std::string ext_list = (char*)glGetString(GL_EXTENSIONS);
        for(auto &extension_str: ITKCommon::StringUtil::tokenizer( ext_list, " " )){
