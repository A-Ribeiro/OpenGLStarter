...
public:
    ...
    void ImGUIDrawAndProcessLogic(int id, PlatformTime *time) {
...
public:
    ...
    PlatformMutex datamutex;
    PlatformThread updateThread;

    ServiceController():updateThread(this, &ServiceController::updateEntryThread)
    {
        updateThread.start();
    }
